        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <Dropdown className='w-full'>
                <Dropdown.Trigger className='w-full'>
                  <Button
                    as="span"
                    variant="outline"
                    className="w-full bg-white text-black rounded-md px-2 text-left flex justify-between items-center"
                  >
              ...
              {errorMessages.salutation && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.salutation}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errorMessages.firstName && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.firstName}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errorMessages.lastName && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.lastName}</p>
              )}
            </div>
            ...
            <div>
              ...
              <Input
                className="w-full bg-white text-black rounded-md px-2  no-border"
                placeholder="Email"
                value={email}
                onChange={(e) => {
            ...
            <div>
              ...
              />
              {errorMessages.DOB && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.DOB}</p>
              )}
            </div>
            ...
            <div>
              ...
              <div>
                ...
                {errorMessages.marital && (
                  <p className="text-red-500 text-sm mt-1">{errorMessages.marital}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.zip && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.zip}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.DurationAddress && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.DurationAddress}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.DurationAddressMonth && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.DurationAddressMonth}</p>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div>
                ...
                {errorMessages.mortage && (
                  <p className="text-red-500 text-sm mt-1">{errorMessages.mortage}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.monthlyPayment && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.monthlyPayment}</p>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              {errorMessages.employerName && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.employerName}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errorMessages.position && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.position}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.employmentDurationYears && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.employmentDurationYears}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.employmentDurationMonths && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.employmentDurationMonths}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.monthlyIncome && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.monthlyIncome}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.supervisorName && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.supervisorName}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.supervisorPhone && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.supervisorPhone}</p>
              )}
            </div>
            ...
            <div>
              ...
              <div>
                <Dropdown className='w-full'>
                  <Dropdown.Trigger className='w-full'>
                    <Button
                      as="span"
                      variant="outline"
                      className="w-full bg-white text-black border border-gray-400 rounded-md px-2 text-left flex justify-between items-center"
                    >
                ...
                {errorMessages.Employe && (
                  <p className="text-red-500 text-sm mt-1">{errorMessages.Employe}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.workAddress && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.workAddress}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.workCity && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.workCity}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.workState && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.workState}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.workZip && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.workZip}</p>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              {errorMessages.PreviousEmployerName && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.PreviousEmployerName}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.PreviousPosition && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.PreviousPosition}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.PreviousEmployementYear && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.PreviousEmployementYear}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.PreviousEmployementMonth && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.PreviousEmployementMonth}</p>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              {errorMessages.ReferenceName && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.ReferenceName}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.ReferencePhone && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.ReferencePhone}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.AdditionalNotes && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.AdditionalNotes}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errorMessages.Hearing && (
                <p className="text-red-500 text-sm mt-1">{errorMessages.Hearing}</p>
              )}
            </div>
          ...
          <div className="flex-1 p-6 max-w-5xl bg-gray-800 mt-10 mx-6 md:mt-12 md:mr-8 rounded-lg">
            ...
            <Input
              className="w-full bg-white text-black border border-gray-400 rounded-md mb-4 px-2"
              placeholder="Enter Vehicle Details"
            />
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Button className="bg-red-600 hover:bg-red-700 text-white py-2 rounded-md px-2">
                Advance Search
              </Button>
