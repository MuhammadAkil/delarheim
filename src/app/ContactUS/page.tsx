    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="relative flex items-start py-5 ">
                ...
                <div className="absolute top-2/2 left-2/2 z-10 text-center px-4 flex flex-col items-center lg:text-white text-black lg:static" style={{ marginLeft: '11em' }}>
                    ...
                    <div className="space-y-4 w-full max-w-[20rem] mx-auto hidden lg:block">
                        <button className="bg-[rgb(11,34,96)] hover:bg-[#0b2260] text-white py-2 px-4 rounded-[20px] mx-2">
                            Call Us
                        </button>
                        <button className="bg-[rgb(11,34,96)] hover:bg-[#0b2260] text-white py-2 px-4 rounded-[20px] mx-2">
                            Chat Now
            ...
            <div className="py-16">
                ...
                <div className="p-6 rounded-lg">  {/* max-w-lg mx-auto   (agr to ap form chota krna chah rhy hain) */}
            ...
            <h2 className="text-2xl font-semibold my-6 text-center mb-10">You can also contact us via:</h2>

            {/* Icons for WhatsApp, Facebook, Instagram */}
            <div className="flex justify-between space-x-16 mb-10">
                <a href="https://wa.me/yourwhatsappnumber" target="_blank" rel="noopener noreferrer">
                    <FaWhatsapp className="text-6xl text-green-500 hover:text-green-600 transition duration-300" />
                </a>
                <a href="https://www.facebook.com/yourfacebookpage" target="_blank" rel="noopener noreferrer">
                    <FaFacebook className="text-6xl text-blue-600 hover:text-blue-700 transition duration-300" />
                </a>
                <a href="https://www.instagram.com/yourinstapage" target="_blank" rel="noopener noreferrer">
                    <FaInstagram className="text-6xl text-pink-600 hover:text-pink-700 transition duration-300" />
                </a>
            </div>
        </div>
    );
