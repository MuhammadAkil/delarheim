...
const ContactUs = () => {
    return (
        <div className="max-w-6xl mx-auto">
            ...
            <div className="py-16">
                <h1 className="text-4xl font-semibold my-6 text-center text-black">Ask a Question</h1>
            ...
            <h2 className="text-2xl font-semibold my-6 text-center mb-4 text-black">You can also contact us via:</h2>
