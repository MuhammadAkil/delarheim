...
const SellCar = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const requiredFields: (keyof SellCarFormData)[] = [
      "make", "vin", "model", "body", "year",
      "transmission", "mileage", "name",
            ...
            <div className="flex-auto px-6 lg:px-10 py-10 pt-4">
              <form onSubmit={handleSubmit}>
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-6">
                  {/* All Input Fields */}
                  {(["make", "vin number", "model", "body", "year", "transmission", "mileage", "carPhotos"] as Array<keyof SellCarFormData>).map((field) => (
                    <div key={field}>
                      <label className="block text-gray-600 text-xs font-bold mb-2 capitalize">
                        {field === "carPhotos" ? "Car Photos" : field.charAt(0).toUpperCase() + field.slice(1)}                      </label>
                      <input
                ...
                <div className="mt-8">
                  <button
                    type="submit"
                    className="!text-white bg-[#6b5fff] hover:bg-[#6b5fff]/90 rounded-[5px] px-20 py-4 text-[20px] font-bold tracking-[0.02857em] leading-6 ">
                    Submit
                  </button>
                </div>
              </form>
